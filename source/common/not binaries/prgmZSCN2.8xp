...
If B=1
Then
"*BLUSHES* OH, I'M-- WELL, MY NAME'S BAXTER.→Str9\
prgmZDRAWTXT
"I'M A BEARCAT. I REALLY LIKE MATH AND SCIENCE, AND THE LIBRARY→Str9\
prgmZDRAWTXT
"I GUESS YOU COULD SAY I'M A BIT OF A NERD.→Str9\
End
If B=2
